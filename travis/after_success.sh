...
if [ $TRAVIS_REPO_SLUG == "fartherp/framework-spring-boot" ] && [ "$TRAVIS_BRANCH" == "master" ] && [[ "$commit_message" != *"[maven-release-plugin]"* ]]; then
  ...
  if [ $TRAVIS_JDK_VERSION == "openjdk8" ]; then
    ...
    # Deploy to sonar
    ./mvnw clean org.jacoco:jacoco-maven-plugin:prepare-agent package sonar:sonar -Dsonar.projectKey=fartherp_framework-spring-boot -Dsonar.host.url=https://sonarcloud.io -Dsonar.login=0aae2c9e85a373ad6e20249f3c9cb4927fa2b81f
